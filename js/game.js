...
class Game {
    constructor() {
        ...
        this.gridSize = 20;
        this.speed = 100; // ms par frame, ajusté par difficulté
        this.score = 0;
        this.lives = 3;
        this.level = 1;
        this.mode = 'classic';
    ...
    resizeCanvas() {
        this.canvas.width = Math.floor(window.innerWidth / this.gridSize) * this.gridSize;
        this.canvas.height = Math.floor((window.innerHeight * 0.7) / this.gridSize) * this.gridSize; // 70% hauteur pour HUD
    }
    ...
    adjustDifficulty() {
        switch (this.difficulty) {
            ...
            case 'expert': this.speed = 50; break;
        }
    }
    ...
    loop() {
        ...
        if (this.mode === 'survival') {
            ...
            if (Math.random() < 0.01) this.obstacles.push({/* ... */ });
        }
    ...
    gameOver() {
        ...
        document.getElementById('final-score').textContent = `Score final: ${this.score}`;
